...
console.log(
  "This script populates some test video games, developers, consoles, and genres to your database. Specified database as argument - e.g.: node populatedb 'mongodb+srv://cooluser:coolpassword@cluster0.lz91hw2.mongodb.net/local_library?retryWrites=true&w=majority'"
);
...
async function developerCreate(name, description, founded, headquarters) {
...
async function consoleCreate(name, creator, description, releaseDate) {
  ...
  const consoleObj = new Console(consoleDetails);
